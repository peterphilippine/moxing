...
class Mamba2LMHeadModel(nn.Module, GenerationMixin):
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, num_last_tokens=0):
        ...
        lm_logits = self.lm_head((hidden_states if num_last_tokens == 0 else hidden_states[:, -num_last_tokens:]).to(self.lm_head.weight.dtype)).transpose(1, 2)
        #return lm_logits
