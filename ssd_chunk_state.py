#%%writefile /usr/local/lib/python3.11/dist-packages/mamba_ssm/ops/triton/ssd_chunk_state.py
...
def init_to_zero(names):
    return lambda nargs: [nargs[name].zero_() for name in names if (name in nargs and nargs[name] is not None)]
